import { RssFeed, Chat, PlayCircleFilledOutlined, Group, Bookmark, HelpOutline, WorkOutlined, Event, School, Person } from '@material-ui/icons';
    ...
    <div className='sidebar'>
        <div className="sidebarWrapper">
            <ul className="sidebarList">
                ...
                <li className="sidebarListItem">
                    <WorkOutlined className="sidebarIcon"></WorkOutlined>
